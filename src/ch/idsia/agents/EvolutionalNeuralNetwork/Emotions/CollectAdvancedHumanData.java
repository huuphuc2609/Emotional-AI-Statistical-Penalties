 ...
 */
public class CollectAdvancedHumanData {
    ...
    public static void main(String[] args) {
        ...
        EmotionalAdvancedHumanAgent agent = new EmotionalAdvancedHumanAgent();
        agent.setnInput(7);
...
//                    marioAIOptions.setLevelDifficulty(1);s
//                    marioAIOptions.setLevelRandSeed(50);
...
//                    }
                    ...
                    try
                    {
                        ...
                        String nameDT = "seqActionHumanPlay"+ name + "_"+ dif + "_" + lev + "_" + times;
...
//                        }
                        HumanData tmpDT = new HumanData(nameDT, agent.seqStateAction);
                        tmpDT.coinGained = basicTask.getEvaluationInfo().coinsGained;
                        tmpDT.killedByFire = basicTask.getEvaluationInfo().killsByFire;
                        tmpDT.killedByStomp = basicTask.getEvaluationInfo().killsByStomp;
                        tmpDT.killedByShell = basicTask.getEvaluationInfo().killsByShell;
                        tmpDT.totalKilled = basicTask.getEvaluationInfo().killsTotal;
                        tmpDT.timeSpent = basicTask.getEvaluationInfo().timeSpent;
                        tmpDT.timeLeft = basicTask.getEvaluationInfo().timeLeft;
                        outfile.write(tmpDT.toString() + "\r\n");
                        Thread.sleep(100);
                        outfile.flush();
                        outfile.close();
