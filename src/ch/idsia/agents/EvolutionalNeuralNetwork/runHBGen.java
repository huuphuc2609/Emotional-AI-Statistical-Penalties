...
import ch.idsia.agents.EvolutionalNeuralNetwork.Agent.HBFullyRBAgent;
...
//        }
        ...
        final HBFullyRBAgent agent = new HBFullyRBAgent();
        agent.nn = net;
        ...
        try
        {
            FileInputStream infile = new FileInputStream("HBFullyRBAgent");
            //infile = new FileInputStream("HBFullyRBAggressiveAgent");
