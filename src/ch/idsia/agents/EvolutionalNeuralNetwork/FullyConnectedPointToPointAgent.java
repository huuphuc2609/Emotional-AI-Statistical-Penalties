 ...
 * @author Phuc
 */
public class FullyConnectedPointToPointAgent extends BasicMarioAIAgent implements Agent {

    public EvolNetwork nn;
    public static boolean debug = false;
    protected boolean Action[] = new boolean[Environment.numberOfKeys];
    protected String name = "FullyConnectedPointToPointAgent";
    ...
    public FullyConnectedPointToPointAgent() {
        super("FullyConnectedPointToPointAgent");
    }
    ...
    public boolean[] getAction()
    {
        ...
        input[sen.length+sen[0].length+2] = 4000;
        input[sen.length+sen[0].length+3] = 223;
        input[sen.length+sen[0].length+2] = marioFloatPos[0];
        input[sen.length+sen[0].length+3] = marioFloatPos[1];
        marioX = marioFloatPos[0];
        marioY = marioFloatPos[1];
