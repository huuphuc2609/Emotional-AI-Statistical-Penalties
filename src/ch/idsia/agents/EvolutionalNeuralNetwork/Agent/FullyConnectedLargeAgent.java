 ...
 * @author Phuc
 */
public class FullyConnectedLargeAgent extends BasicMarioAIAgent implements Agent {

    public EvolNetwork nn;
    public static boolean debug = false;
    protected boolean Action[] = new boolean[Environment.numberOfKeys];
    protected String name = "FullyConnectedLargeAgent";
    ...
    public FullyConnectedLargeAgent() {
        super("FullyConnectedLargeAgent");
    }
    ...
    public boolean[] getAction()
    {
        ...
        double[] input = new double[18*18+2];
        int idx = 0;
